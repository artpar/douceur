# douceur [![Build Status](https://secure.travis-ci.org/artpar/douceur.svg?branch=master)](http://travis-ci.org/artpar/douceur)

A simple CSS parser and inliner in Golang.

![Douceur Logo](https://github.com/artpar/douceur/blob/master/douceur.png?raw=true "Douceur")
...
Install tool:
    ...
    $ go install github.com/artpar/douceur
...
Fetch package:
    ...
    $ go get github.com/artpar/douceur
